...
export class Api {
  ...
  constructor(private readonly baseURL: string = process.env.NEXT_PUBLIC_API_URL || "http://localhost:4001/api/v1") {
  ...
  updateNote = async (id: string, payload: { title?: string; content?: string }) => {
