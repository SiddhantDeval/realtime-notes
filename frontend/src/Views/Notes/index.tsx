  ...
  return (
    <div className="bg-surface-muted-dark dark:bg-surface-primary min-h-[calc(100dvh-121px-65px)] md:min-h-[calc(100dvh-65px-65px)] h-full overflow-y-hidden">
      <div className="relative lg:flex h-full">
         <aside
        className="hidden lg:flex lg:flex-col lg:w-64 bg-white dark:bg-[#1f1d33] border-r border-gray-200 dark:border-gray-700 p-4"
      >
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-3">
              <div
                ...
                style={{
                  backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCkYdhdMThoGbFIt9mbzcJ_ktDC_ym0DMvh9NlDQhvHUr-XCptWh0LJPcrMqPGpxQhzRNkRf1Q2CC0b-9BBjCZh9C3a6yP5CL8RHJ2q8Uf1K21bP0mjfCKNklLVDjPdh7o96eEv04BfRBgJ2FLmu0X7DWpu2Xx18zfKzSgNa9ma8HOGW-tgYGo7PH0PLIJeP7w888BE6XCFAkw8vsj-Xp0c4GRqrUcq0Hh2oj9aGQX9nXQQ0ibC0aWnMvJiN813sqhh0dFPzDax-Fwo')"
                }}
              ></div>
              <div className="flex flex-col">
                <h1
                  className="text-[#0f0e1b] dark:text-white text-base font-bold leading-normal"
                >
                  SyncNotes
                </h1>
                <p
                  className="text-[#564f96] dark:text-gray-400 text-sm font-normal leading-normal"
                >
            ...
            <nav className="flex flex-col gap-2">
              ...
              >
                <span
                  className="material-symbols-outlined text-[#0f0e1b] dark:text-white text-2xl"
                  >star</span
                >
                <span
                  className="text-[#0f0e1b] dark:text-white text-sm font-medium leading-normal"
                  >Favorites</span
                >
              </a>
              <a
